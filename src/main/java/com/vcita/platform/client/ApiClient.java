...
import com.vcita.platform.client.auth.Authentication;
import com.vcita.platform.client.auth.HttpBasicAuth;
import com.vcita.platform.client.auth.HttpBearerAuth;
import com.vcita.platform.client.auth.ApiKeyAuth;
import com.vcita.platform.client.auth.OAuth;
import com.vcita.platform.client.auth.RetryingOAuth;
import com.vcita.platform.client.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "http://api.vcita.biz/platform/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("default", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.vcita.biz/platform/v1
     ...
     * @return a {@link com.vcita.platform.client.ApiClient} object
     */
     ...
     * @throws com.vcita.platform.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.vcita.platform.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.vcita.platform.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.vcita.platform.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.vcita.platform.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.vcita.platform.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.vcita.platform.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.vcita.platform.client.ApiException If fail to serialize the request body object into a string
     */
