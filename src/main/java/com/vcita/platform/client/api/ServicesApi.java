...
public class ServicesApi {
    ...
    public ApiResponse<CategoriesCategoryIdServicesGet200Response> categoriesCategoryIdServicesGetWithHttpInfo(String categoryId, String businessId, String authorization, List<String> staffArray, Boolean hasFutureInstance, Integer page, Integer perPage) throws ApiException {
        ...
        try {
            ...
            e.setErrorObject(localVarApiClient.getJSON().getGson().fromJson(e.getResponseBody(), new TypeToken<CategoriesCategoryIdServicesGet200Response>(){}.getType()));
            e.setErrorObjectType(new GenericType<CategoriesCategoryIdServicesGet200Response>(){});
            throw e;
        }
    }
    ...
    public ApiResponse<GlobalServicesGet200Response> globalServicesGetWithHttpInfo(String date, String authorization, Integer page) throws ApiException {
        ...
        try {
            ...
            e.setErrorObject(localVarApiClient.getJSON().getGson().fromJson(e.getResponseBody(), new TypeToken<GlobalServicesGet200Response>(){}.getType()));
            e.setErrorObjectType(new GenericType<GlobalServicesGet200Response>(){});
            throw e;
        }
    }
    ...
    public ApiResponse<ServicesGet200Response> servicesGetWithHttpInfo(String businessId, String authorization, List<String> staffArray, Boolean hasFutureInstance, Boolean includeHidden, Boolean activeStaffOnly, Boolean extraDecoratorFields, Integer page, Integer perPage) throws ApiException {
        ...
        try {
            ...
            e.setErrorObject(localVarApiClient.getJSON().getGson().fromJson(e.getResponseBody(), new TypeToken<ServicesGet200Response>(){}.getType()));
            e.setErrorObjectType(new GenericType<ServicesGet200Response>(){});
            throw e;
        }
    }
    ...
    public ApiResponse<ServicesServiceIdGet200Response> servicesServiceIdGetWithHttpInfo(String serviceId, String authorization) throws ApiException {
        ...
        try {
            ...
            e.setErrorObject(localVarApiClient.getJSON().getGson().fromJson(e.getResponseBody(), new TypeToken<ServicesServiceIdGet200Response>(){}.getType()));
            e.setErrorObjectType(new GenericType<ServicesServiceIdGet200Response>(){});
            throw e;
        }
    }
