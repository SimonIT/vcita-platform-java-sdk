...
import com.vcita.platform.client.model.AppData;
...
public class Data2 {
  ...
  public Data2 appData(AppData appData) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Data2 data2 = (Data2) o;
    return Objects.equals(this.appData, data2.appData);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Data2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Data2.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Data2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Data2` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      // validate the optional field `app_data`
      if (jsonObj.getAsJsonObject("app_data") != null) {
        AppData.validateJsonObject(jsonObj.getAsJsonObject("app_data"));
      }
  }
