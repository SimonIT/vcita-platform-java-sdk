...
public class Tax {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Tax
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Tax.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Tax.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Tax` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
