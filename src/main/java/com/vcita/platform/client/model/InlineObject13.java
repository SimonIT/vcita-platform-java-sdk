...
public class InlineObject13 {
  ...
  public InlineObject13 sections(List<Object> sections) {

    this.sections = sections;
    return this;
  }

  public InlineObject13 addSectionsItem(Object sectionsItem) {
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonArraysections != null) {
        for (int i = 0; i < jsonArraysections.size(); i++) {
          //Object.validateJsonObject(jsonArraysections.get(i).getAsJsonObject());
        };
      }
  }
