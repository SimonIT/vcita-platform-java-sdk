...
public class Data3 {
  ...
  public Data3 appData(AppData1 appData) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Data3 data3 = (Data3) o;
    return Objects.equals(this.appData, data3.appData);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Data3.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Data3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Data3` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
